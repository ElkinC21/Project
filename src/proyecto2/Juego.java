...
public class Juego extends javax.swing.JFrame {
    ...
    private void PartidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PartidaActionPerformed
        ...
        ProyectoStratego game = new ProyectoStratego();
        game.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_PartidaActionPerformed
public void gameFinished(String result, int score) {
        if (usuarioActual != null) {
            juego gameLog = new juego(result, score); 
            
            usuarioActual.registrojuegos(gameLog); 


            usuarioActual.setPuntaje(usuarioActual.getPuntaje() + score);

            this.setVisible(true);
            
            JOptionPane.showMessageDialog(this, "Partida terminada: " + result + " con " + score + " puntos.");
        } else {
